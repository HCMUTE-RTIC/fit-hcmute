...
export const metadata = generatePageMetadata({
  title: 'Thành tựu',
  description: 'Thành tựu nổi bật của Khoa Công nghệ Thông tin - Đại Học Công Nghệ Kỹ thuật TP. Hồ Chí Minh. Giải thưởng, nghiên cứu khoa học và đóng góp cho cộng đồng.',
