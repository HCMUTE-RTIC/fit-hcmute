...
export const metadata = generatePageMetadata({
  ...
  description: 'Hành trình 25 năm phát triển của Khoa Công nghệ Thông tin - Đại Học Công Nghệ Kỹ thuật TP. Hồ Chí Minh. Những cột mốc quan trọng và thành tựu đáng tự hào.',
