    ...
    <footer className="bg-white border-t border-gray-100">
      <div className="max-w-[1280px] mx-auto px-6 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-gray-100 text-center" style={{ color: 'var(--color-text-gray)' }}>
          <p>© 2026 Khoa Công nghệ Thông tin - Trường Đại Học Công Nghệ Kỹ thuật Tp. Hồ Chí Minh</p>
          <p className="mt-2">
            <span style={{ color: 'var(--color-accent-500)' }}>❤</span> Kỷ niệm 25 năm thành lập (2001 - 2026)
          </p>
          <p className="mt-2 text-sm">
            Được phát triển bởi <a href="https://www.facebook.com/hcmute.rtic" target="_blank" rel="noopener noreferrer" className="font-semibold hover:underline" style={{ color: 'var(--color-primary-600)' }}>HCM UTE Research on Technology and Innovation Club</a>
          </p>
        </div>
      </div>
    </footer>
