...
_Trang web lúc này sẽ live ở địa chỉ: `http://localhost:3001` (Cổng 3001 đã được map sẵn cho Backend)._
...
_Tất cả component sau khi cài sẽ tự động chui vào folder: `packages/ui/src/components/` và có thể import trực tiếp từ nextjs thông qua tên package (VD: `@repo/ui/components/ui/button`)_
