    ...
    <div style={scaleStyle} className={className}>
      ...
      >
        ...
        >
          ...
          {papers.map((item, i) => {
            ...
            return (
              <div
                ...
                className={`absolute z-20 bottom-[10%] left-1/2 transition-all duration-700 ease-in-out ${
          ...
          <div
            className={`absolute z-30 w-full h-full origin-bottom transition-all duration-700 ease-in-out ${
